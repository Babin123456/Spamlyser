...
LanguageCode = Literal[
    ...
    "ja", "ko", "hi", "bn", "ta", "te", "mr", "gu", "pa", "ur",
    "vi", "th", "tr", "pl", "ro", "cs", "hu", "el", "he", "id",
    "ms", "tl", "sv", "da", "fi", "no", "uk", "bg", "sr", "hr",
    "sk", "sl", "lt", "lv", "et", "unknown",
]
...
_STOP_SETS: dict[LanguageCode, set[str]] = {
    "en": {"the", "is", "and", "to", "of", "in", "it", "you", "that", "he", "was", "for", "on", "are", "with"},
    "es": {"el", "la", "de", "que", "y", "en", "un", "ser", "por", "con", "no", "su", "para", "como", "más"},
    "fr": {"le", "la", "de", "et", "un", "être", "dans", "pour", "sur", "pas", "avec", "ce", "il", "elle", "nous"},
    "de": {"der", "die", "das", "und", "ist", "ein", "eine", "auf", "für", "mit", "nicht", "sich", "auch", "bei", "von"},
    "it": {"il", "lo", "la", "di", "che", "e", "un", "una", "per", "con", "su", "non", "si", "sono", "come"},
    "pt": {"o", "a", "de", "que", "e", "um", "para", "com", "não", "uma", "os", "as", "se", "é", "por"},
    "nl": {"de", "het", "een", "van", "en", "is", "te", "met", "voor", "niet", "op", "zijn", "aan", "dat", "die"},
    "pl": {"i", "w", "na", "z", "się", "do", "a", "to", "nie", "że", "jak", "od", "ma", "dla", "jest"},
    "ro": {"și", "de", "a", "în", "un", "o", "cu", "pe", "la", "că", "este", "nu", "sunt", "din", "mai"},
    "cs": {"a", "v", "na", "se", "je", "že", "do", "to", "s", "z", "o", "pro", "za", "si", "ale"},
    "hu": {"a", "az", "és", "hogy", "nem", "egy", "meg", "van", "is", "azt", "csak", "volt", "lesz", "mint", "már"},
    "sv": {"och", "i", "är", "det", "som", "en", "på", "att", "ett", "till", "med", "för", "inte", "har", "om"},
    "da": {"og", "i", "er", "det", "en", "at", "til", "på", "med", "for", "han", "som", "ikke", "har", "vi"},
    "fi": {"ja", "on", "ei", "se", "en", "oli", "hän", "mutta", "myös", "yksi", "voi", "että", "siitä", "ole", "tai"},
    "id": {"dan", "di", "ke", "dengan", "yang", "ini", "untuk", "tidak", "ada", "dari", "akan", "dalam", "saya", "ia", "juga"},
    "ms": {"dan", "di", "ke", "yang", "ini", "untuk", "tidak", "ada", "dari", "akan", "dalam", "saya", "ia", "juga", "itu"},
    "tl": {"ang", "ay", "ng", "sa", "at", "na", "ngunit", "ito", "iyon", "ko", "mo", "kanya", "aking", "atin", "aming"},
    "tr": {"bir", "ve", "bu", "ile", "için", "daha", "ben", "sen", "o", "biz", "siz", "onlar", "değil", "çok", "gibi"},
    "vi": {"và", "là", "của", "có", "trong", "cho", "không", "người", "này", "một", "tại", "nhưng", "hoặc", "được", "sẽ"},
    "el": {"και", "το", "η", "να", "για", "με", "του", "τη", "τα", "σε", "στο", "του", "τις", "από", "που"},
}

# European languages that share the Latin script
_LATIN_LANGS: list[LanguageCode] = [
    "en", "es", "fr", "de", "it", "pt", "nl", "pl", "ro", "cs",
    "hu", "sv", "da", "fi", "id", "ms", "tl", "tr", "vi",
]
