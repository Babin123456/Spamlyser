        ...
        if uploaded_file is not None:
            try:
                ...
                if (
                    ...
                    if result["ensemble_predictions"]["majority_voting"][
                        "label"
                    ] == "SPAM":
                ...
                if (
                    ...
                    if st.session_state.batch_cancel:
                        ...
                        st.warning(
                            f"⏹️ Processing cancelled. {cancelled_msg}."
                        )
                    else:
...
"""
                ...
                if not st.session_state.batch_processing:
                    if st.button(
                        ...
                        st.session_state.batch_queue = df[
                            "message"
                        ].tolist()
                        st.session_state.batch_results = []
                ...
                if not st.session_state.batch_processing and st.session_state.batch_results:
